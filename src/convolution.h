...
template<int IN_CHANNEL, int OUT_CHANNEL>
class ConvolutionalLayer {
    ...
    using Input   = std::array<std::array<std::array<float, DIM2_PADDED>, DIM1_PADDED>, IN_CHANNEL >;
    using Output  = std::array<std::array<std::array<float, DIM2_PADDED>, DIM1_PADDED>, OUT_CHANNEL>;
    using Weights = std::array<std::array<std::array<std::array<float, KERNEL_SIZE>, KERNEL_SIZE>, IN_CHANNEL>, OUT_CHANNEL>;
    using Biases  = Output;
