...
public:
    ...
    const std::array<int16_t, L1_SIZE * L2_SIZE * 2 * 2>& weights1;
...
<<<<<<< HEAD
            output += screlu(accumulator[nSTM]) * weights1[o + (sq * MINI_ACC_SIZE * 2) + i                ];
            output += screlu(accumulator[nNTM]) * weights1[o + (sq * MINI_ACC_SIZE * 2) + i + MINI_ACC_SIZE];
=======
