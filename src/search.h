...
inline void TuneOptions::init() {
    TUNEFLOAT(LMRBase, 0.75, 0.01, 2)
    TUNEFLOAT(LMRDiv, 2.19, 0.01, 3)
    TUNEFLOAT(LMRImproving, 0.55, 0, 1.2)
    TUNEINT(LMRDepth, 2, 1, 4)
    TUNEINT(LMRMovecount, 2, 1, 4)
    TUNEINT(LMRHistDivPos, 5000, 1, 40000)
    TUNEINT(LMRHistDivPos, 25000, 1, 40000)
